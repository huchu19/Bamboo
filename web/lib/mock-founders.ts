...
export const FOUNDERS: Founder[] = [
  {
    ...
    bio: 'Former student, future revolutionary. Changing the world one pessimist at a time.',
    activeSince: '2025-08',
    rootVerified: true,
    followers: 184,
    milestones: [
      { date: '2025-08', label: 'Founded EduNexus', detail: 'Final Year Project kick-off, QMUL EECS', kind: 'founded' },
      { date: '2025-10', label: 'Project Definition Plan submitted', detail: 'Scope, architecture, and research objectives approved', kind: 'milestone' },
      { date: '2026-01', label: 'MVP shipped', detail: 'Full-stack platform live — lesson generation, adaptive quizzes, knowledge graph', kind: 'milestone' },
      { date: '2026-03', label: 'Root-Verified', detail: 'Platform independently reviewed and verified', kind: 'verified' },
      { date: '2026-04', label: 'Seed round listed', detail: '$2.3M ask · $11.4M pre-money · 20% equity · SAFE structure', kind: 'pitch' },
      { date: '2026-06', label: 'Crossed 62% raised', detail: '47 backers · $1.43M committed · 18 days to close', kind: 'raise' },
    ],
    backers: [
      { name: 'QMUL Innovation Fund', kind: 'Lead' },
